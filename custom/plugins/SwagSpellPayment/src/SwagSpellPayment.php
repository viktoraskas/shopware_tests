...
use SwagSpellPayment\Service\ExamplePayment;

class SwagSpellPayment extends Plugin
{
    ...
    private function addPaymentMethod(Context $context): void
    {
        ...
        $examplePaymentData = [
            ...
            'name' => 'Luminor payment gateway',
            'description' => 'Luminor payment gateway',
            'pluginId' => $pluginId,
        ];
